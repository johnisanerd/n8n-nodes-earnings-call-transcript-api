...
import { properties } from './ApifyEarningsCalls.properties';
import { runActor } from './helpers/executeActor';

// SNIPPET 1: Make sure the constants are correct
export const ACTOR_ID = 'OYmaEgBLPCE3cDiCQ' as string;

export const PACKAGE_NAME = 'n8n-nodes-earnings-call-transcript-api' as string;
export const CLASS_NAME = 'ApifyEarningsCalls' as string;
...
export const X_PLATFORM_APP_HEADER_ID = 'earnings-call-transcript-app' as string;

export const DISPLAY_NAME = 'Earnings Calls and SEC Filings' as string;
export const DESCRIPTION =
	'Get speaker-tagged earnings call transcripts and parsed SEC 8-K filings as structured JSON' as string;

export class ApifyEarningsCalls implements INodeType {
	description: INodeTypeDescription = {
		...
		subtitle: 'Get Transcripts and Filings',
